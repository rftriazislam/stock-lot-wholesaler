    ...
    "country":
        [
            ...
            },
            {
                ...
                "alpha2_code": "UM",
                "country_code": "1",
                "states": [{ "state_name": "United States Minor Outlying I" }]
            },
            {
...
$('#country').on('change', function () {
    ...
    var country = this.options[this.selectedIndex].getAttribute("toname");
    ...
    for (var i = 0; i < myJson.country.length; i++) {
        if (myJson.country[i].country_code == $(this).val()) {
            ...
            $('#country_3').html('<input id="input_3" class="form-control"  value="' + country + '" name="flg" type="hidden" >');
