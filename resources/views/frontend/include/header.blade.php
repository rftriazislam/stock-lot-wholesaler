      ...
      <div class="header__top" style="color:white;background:black">
          <div class="container">
              <div class="header__left">
                  <p style="color: white">Welcome to Stock Lot Wholesale Marketplace </p>
              </div>
              ...
              <div class="header__content-left"><a class="ps-logo" href="{{ route('home') }}"><img
                  ...
                  <div class="menu--product-categories">
                      <div class="menu__toggle"><span> <a href="{{ route('home') }}"><img
                                      src="{{ asset('frontend') }}/img/logo/2hh.png" alt=""></a></span></div>
...
<div class="navigation__content">
  <div id="cartmobile" class="ps-cart--mobile">
