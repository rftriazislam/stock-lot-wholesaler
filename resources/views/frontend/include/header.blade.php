                              ...
                              <div class="ps-cart__items">
                                  <div class="ps-product--cart-mobile">
                                      <div class="ps-product__thumbnail"><a href="#"><img
                                                  src="{{ asset('frontend') }}/img/products/clothing/7.jpg"
                                                  alt=""></a>
                                      </div>
                                  ...
                                  <div class="ps-product--cart-mobile">
                                      <div class="ps-product__thumbnail"><a href="#"><img
                                                  src="{{ asset('frontend') }}/img/products/clothing/5.jpg"
                                                  alt=""></a>
                                      </div>
                                      <div class="ps-product__content"><a class="ps-product__remove" href="#"><i
      ...
      <div class="header__top">
          ...
          <div class="header__right">
              <ul class="navigation__extra">
                  ...
                  <li>
                      <div class="ps-dropdown language"><a href="#"><img src="{{ asset('frontend') }}/img/flag/en.png"
                                  alt="">English</a>
                          <ul class="ps-dropdown-menu">
                              <li><a href="#"><img src="{{ asset('frontend') }}/img/flag/germany.png" alt="">
                                      Germany</a></li>
  ...
  <div class="ps-panel--sidebar" id="menu-mobile">
      ...
      <div class="ps-panel__content">
          <ul class="menu--mobile">
              <li class="current-menu-item menu-item-has-children"><a href="index.html">Home</a><span
                      class="sub-toggle"></span>
                  <ul class="sub-menu">
