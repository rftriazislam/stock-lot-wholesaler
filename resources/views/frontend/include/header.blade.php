  <header class="header header--standard header--market-place-4" data-sticky="true">
      ...
      <div class="header__content">
        <div class="container">
          <div class="header__content-left"><a class="ps-logo" href="index.html"><img src="{{asset('frontend')}}/img/logo_light.png" alt=""></a>
    ...
    <header class="header header--mobile" data-sticky="true">
      ...
      <div class="navigation--mobile">
        <div class="navigation__left"><a class="ps-logo" href="index.html"><img src="{{asset('frontend')}}/img/logo_light.png" alt=""></a></div>
