<footer class="ps-footer ps-footer--3">
    <div class="container">
        ...
        <div class="ps-footer__links">
            ...
            <p><strong>Health &amp; Beauty:</strong><a href="#">Hair Care</a><a href="#">Decoration</a><a href="#">Hair
                    Care</a><a href="#">Makeup</a><a href="#">Body Shower</a><a href="#">Skin Care</a><a
                    href="#">Cologine</a><a href="#">Perfume</a>
            </p>
            <p><strong>Jewelry &amp; Watches:</strong><a href="#">Necklace</a><a href="#">Pendant</a><a href="#">Diamond
                ...
                <div class="ps-product__header">
                    <div class="ps-product__thumbnail" data-vertical="false">
                        <div class="ps-product__images" data-arrow="true">
                            <div class="item"><img
                                    src="{{ asset('frontend') }}/img/products/detail/fullwidth/1.jpg" alt=""></div>
                            <div class="item"><img
                                    src="{{ asset('frontend') }}/img/products/detail/fullwidth/2.jpg" alt=""></div>
                            <div class="item"><img
                                    src="{{ asset('frontend') }}/img/products/detail/fullwidth/3.jpg" alt=""></div>
                        </div>
                    </div>
