    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 ">
            <div class="x_panel fixed_height_320">
                <div class="x_title">
                    <h2>Top Product <small>Sale</small></h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="tile_info">
                                    <tr>
                                        <td>
                                            <p><i class="fa fa-square blue"></i>Buy </p>
                                        </td>
                                        <td>30%</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><i class="fa fa-square green"></i>Review </p>
                                        </td>
                                        <td>10%</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><i class="fa fa-square purple"></i>Order </p>
                                        </td>
                                        <td>20%</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><i class="fa fa-square aero"></i>views </p>
                                        </td>
                                        <td>15%</td>
                                    </tr>
                                    <tr>
