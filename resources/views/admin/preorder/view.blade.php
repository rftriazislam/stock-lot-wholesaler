            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <br />
                        <form id="demo-form2" action="{{ route('admin.preproduct.update') }}" method="POST"
                            ...
                            <div class="borderr pb_695">
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label btn col-md-3 col-sm-3 label-align" for="prsice">Total
                                        Price
                                        <sup class="required" style="color: red"></sup>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="toprice" disabled class="form-control "
                                            value="{{ $product->price + $product->service_charge }} {{ Auth::user()->currency }}">
                            ...
                            <div class="borderr pb_695">
                                ...
                                <h5 style="text-align: center;padding-top: 9px">Delivery Details</h5>
                                <hr>


                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Expried
                                        Time
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="datetime-local" id="first-name" placeholder="12-12-2021" name="date"
                                            value="{{ $product->preproduct->expried_time }}" class="form-control ">
                                    </div>
                                    <br>
                                    <p>{{ $product->preproduct->expried_time }}</p>
                                </div>


                                <div class="item form-group">
                                    <label class="col-form-label btn col-md-3 col-sm-3 label-align"
                                        for="product_name2">Delivery Date
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="date" name="delivery_date" class="form-control "
                                            placeholder="12-12-2021" value="{{ $product->preproduct->delivery_date }}"
                                            autofocus autocomplete>
                                    </div>
                                    <p>{{ $product->preproduct->delivery_date }}</p>

                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label btn col-md-3 col-sm-3 label-align" for="files">Delivery
                                        Address
                                        <sup class="required">*</sup>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <div class="input-group hdtuto control-group lst increment4">
                                            <input type="text" name="deliveryy[]" class="myfrm form-control"
                                                placeholder="Dhaka to Dhaka 200 BDT" multiple>

                                            <div class="input-group-btn">
                                                <button class="btn btn-success  btn_color4" type="button"><i
                                                        class="fldemo glyphicon glyphicon-plus"></i>Add</button>
                                            </div>
                                        </div>
                                        @if ($product->delivery)
                                            @foreach ($product->delivery as $item)
                                                ...
                                                <div class="hdtuto control-group lst input-group" id="remove"
                                                    style="margin-top:10px">
                                                    <input type="text" name="deliveryy[]" class=" form-control" multiple
                                                        value="{{ $item['delivery'] }}">
                                                    <div class="input-group-btn">
                                                        <button id="button" class="btn btn-danger btn_danger4"
                                                            type="button"><i class="fldemo glyphicon glyphicon-remove"></i>
                                                            Remove</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        @endif
                                        <div class="clone4 hide" style="display:none">
                                            <div class="hdtuto control-group lst input-group" id="remove"
                                                style="margin-top:10px">
                                                <input type="text" name="deliveryy[]" placeholder="Dhaka to Dhaka 200 BDT"
                                                    class="myfrm form-control">
                                                <div class="input-group-btn">
                                                    <button id="button" class="btn btn-danger btn_danger4" type="button"><i
                                                            class="fldemo glyphicon glyphicon-remove"></i>
                                                        Remove</button>
                                                </div>
                                            </div>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <a class="btn btn-round  btn-danger"
                                        href="{{ route('pre.product.lists') }}">Back</a>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            //--------------------------------------------size---------------
            $(".btn_color4").click(function() {
                var lsthmtl = $(".clone4").html();
                $(".increment4").after(lsthmtl);

            });


            $("body").on("click", ".btn_danger4", function() {
                $(this).parents("#remove").remove();
            });
        });
