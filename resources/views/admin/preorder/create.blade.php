            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <br />
                        <form id="demo-form2" action="{{ route('admin.save.product') }}" method="POST"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="number" id="stock" name="stock" required="required"
                                            value="{{ old('stock') }}" autofocus autocomplete placeholder="100"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="number" id="price" required="required" min="1" name="price"
                                            class="form-control "
                                            placeholder="100 {{ Auth::user()->currency }} per unit">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="number" id="discount1" required="required" min="1"
                                            name="min_retail_price" class="form-control " placeholder="150">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="number" id="discount2" required="required" min="1"
                                            name="max_retail_price" class="form-control " placeholder="200">
                                    </div>
                                </div>
                                <div class="item form-group">
                            ...
                            <div class="borderr pb_695">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="datetime-local" id="first-name" required="required" name="date"
                                            class="form-control ">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="date" required="required" name="delivery_date" class="form-control "
                                            placeholder="12-12-2021" value="{{ old('delivery_date') }}" autofocus
                                            autocomplete>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <div class="input-group hdtuto control-group lst increment4">
                                            <input type="text" name="delivery[]" class="myfrm form-control"
                                        ...
                                        <div class="clone4 hide" style="display:none">
                                            <div class="hdtuto control-group lst input-group" id="remove"
                                                style="margin-top:10px">
                                                <input type="text" name="delivery[]" placeholder="Dhaka to Dhaka 200 BDT"
