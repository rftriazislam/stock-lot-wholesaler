                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class="headings">
                                ...
                                <th class="column-title">Expried Time</th>
                                <th class="column-title">Dalivery Date</th>
                        ...
                        <tbody>
                            @foreach ($products as $item)
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" ">{{ $item->preproduct->expried_time }}</td>
                                    <td class=" ">{{ $item->preproduct->delivery_date }}
                                    <td class=" ">

                                        @if ($item->status == 4)
                                            <a class="btn btn-success" style="color:white">Published</a>
                                        @endif
