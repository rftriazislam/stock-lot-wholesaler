                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="ps-form__content">
                    <h5>Register An Account</h5>
                      ...
                      <select  name="role" class="form-control @error('role') is-invalid @enderror" value="{{ old('role') }}" required autocomplete="role" autofocus  type="text" placeholder="Merchant or Reseller">
