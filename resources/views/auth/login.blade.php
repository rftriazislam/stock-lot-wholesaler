            ...
            <div class="container">
                        ...
                        <div class="ps-form--account ps-tab-rsoot">
                            <div class="ps-tab-list">
                                <div style="width:100%;max-width:50%;margin-right:0;padding:20px 15px;"><a
                                        href="{{ route('login') }}"
                                        style="font-size:24px;line-height:1em;color:#fcb800;font-weight:600;">Login</a>
                                </div>
                                <div style="width:100%;max-width:50%;margin-right:0;padding:20px 15px;"><a
                                        href="{{ route('register') }}"
                                        style="font-size:24px;line-height:1em;color:#666;font-weight:600;">Register</a>
                                </div>
                ...
                <div class="ps-section__right">
                    <figure class="ps-section__desc">
                        ...
                        <p>MartFury Buyer Protection has you covered from click to delivery. Sign up or sign in and you will
                            be able to:</p>
                        <ul class="ps-list">
